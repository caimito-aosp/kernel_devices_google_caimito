...
#define KM4_TE2_FALLING_EDGE_OFFSET 0x32
#define KM4_TE2_FALLING_EDGE_OFFSET_NS 0x25 //todo: figure this out
...
static const struct exynos_binned_lp km4_binned_lp[] = {
	BINNED_LP_MODE_TIMING("low", 766, km4_lp_low_cmds,
				KM4_TE2_RISING_EDGE_OFFSET, KM4_TE2_FALLING_EDGE_OFFSET),
	BINNED_LP_MODE_TIMING("high", 3307, km4_lp_high_cmds,
				KM4_TE2_RISING_EDGE_OFFSET, KM4_TE2_FALLING_EDGE_OFFSET),
};
...
static void km4_update_te2_internal(struct exynos_panel *ctx, bool lock)
{
	...
	if (test_bit(FEAT_OP_NS, spanel->feat)) {
		rising = KM4_TE2_RISING_EDGE_OFFSET;
		falling = KM4_TE2_FALLING_EDGE_OFFSET;
	} else {
...
static void km4_disable_idle(struct exynos_panel *ctx, bool is_aod)
{
	struct km4_panel *spanel = to_spanel(ctx);
