...
static const struct gs_dsi_cmd tk4b_init_cmds[] = {
	...
	/* Deburn in setting */
	GS_DSI_CMD(0xBB, 0xF3),
	/* CMD2, Page8 */
	GS_DSI_CMD(0xF0, 0x55, 0xAA, 0x52, 0x08, 0x08),
	/* Deburn in setting */
	GS_DSI_CMD(0xC2, 0x33, 0x00, 0x78, 0x03, 0x82, 0x00),
	GS_DSI_CMD(0x6F, 0x06),
	GS_DSI_CMD(0xC2, 0x79, 0xA5, 0xBF, 0xD2, 0xE1, 0xEF, 0xFA),
	GS_DSI_CMD(0xC3, 0x00, 0x00, 0x02, 0x00, 0x02, 0x08, 0x00, 0x08,
	...
	GS_DSI_CMD(0xC8, 0x00, 0x00, 0x01, 0x02, 0x04, 0x09, 0x13, 0x26, 0x4C),
	GS_DSI_CMD(0xC9, 0x00, 0x01, 0x03, 0x06, 0x0C, 0x18, 0x30, 0x60, 0xC0),
	GS_DSI_CMD(0xCA, 0x00, 0x01, 0x02, 0x04, 0x08, 0x10, 0x20, 0x40, 0x80),
	GS_DSI_CMD(0xCB, 0x11, 0x00, 0x00, 0x32, 0x00, 0x00, 0x75, 0x00,
				0x00, 0xBB, 0x00, 0x00, 0x9A, 0x00, 0x00, 0xF9,
				0x00, 0xFF),
	GS_DSI_CMD(0xCC, 0x22, 0x00, 0x00, 0x32, 0x00, 0x00, 0x52, 0x00,
				0x00, 0xA7, 0x00, 0x00, 0xBB, 0x00, 0x00, 0xFB,
				0x00, 0xFF),
	GS_DSI_CMD(0xCE, 0x22, 0x00, 0x00, 0x32, 0x00, 0x00, 0x63, 0x00,
				0x00, 0xAA, 0x00, 0x00, 0xAC, 0x00, 0x00, 0xFA,
				0x00, 0xFF),
	GS_DSI_CMD(0xCF, 0x56, 0x00, 0x00, 0x45, 0x00, 0x00, 0x54, 0x00,
