...
KBUILD_OPTIONS += CONFIG_DRM_PANEL_GOOGLE_BIGSURF=m
KBUILD_OPTIONS += CONFIG_DRM_PANEL_GOOGLE_HK3=m
KBUILD_OPTIONS += CONFIG_DRM_PANEL_GOOGLE_SHORELINE=m
KBUILD_OPTIONS += CONFIG_DRM_PANEL_GOOGLE_TK4A=m
KBUILD_OPTIONS += CONFIG_DRM_PANEL_GOOGLE_TK4B=m
KBUILD_OPTIONS += CONFIG_DRM_PANEL_GOOGLE_TK4C=m
KBUILD_OPTIONS += CONFIG_DRM_PANEL_GS_CM4=m
KBUILD_OPTIONS += CONFIG_DRM_PANEL_GS_KM4=m
